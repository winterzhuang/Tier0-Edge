 ...
 ******************************************************************************/
     ...
     */
    lang: process.env.OS_LANG || "en-US",
 ...
 ******************************************************************************/
    ...
    editorTheme: {
        page: {
            title: 'supos',
            favicon: path.join(__dirname, "themes", "log.svg"),
            css: path.join(__dirname, "themes", "index.css"),
            scripts: [
                path.join(__dirname, "themes", "index.js") // 自定义 JavaScript 文件路径
            ]
        },
        header: {
            title: "supos",
            image: path.join(__dirname, "themes", "title-logo.png")
